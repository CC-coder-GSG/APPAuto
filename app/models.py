...
class Version(Base):
    ...
    bugs: Mapped[list[BugTracking]] = relationship("BugTracking", back_populates="major_version", cascade="all, delete-orphan")
...
class BugTracking(Base):
    ...
    major_version: Mapped[Version] = relationship("Version", back_populates="bugs")
