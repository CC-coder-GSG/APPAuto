...
const OPTIONAL_TAB_MODULES = [
  { name: 'mine', path: './tabs/mine.js?v=20260716-4' },
  { name: 'review-workbench', path: './tabs/review-workbench.js?v=20260716-1' },
  { name: 'task-workbench', path: './tabs/task-workbench.js?v=20260717-1' },
  { name: 'task-board', path: './tabs/task-board.js?v=20260717-1' },
  { name: 'feedback', path: './tabs/feedback.js?v=20260417-3' },
  { name: 'report', path: './tabs/report.js?v=20260710-1' },
  { name: 'retest', path: './tabs/retest.js?v=20260716-4' },
