...
import './zentao-hydrator.js?v=20260630-1';
...
import './components/entity-preview-modal.js?v=20260630-1';
...
const OPTIONAL_TAB_MODULES = [
  { name: 'mine', path: './tabs/mine.js?v=20260630-1' },
  { name: 'task-board', path: './tabs/task-board.js?v=20260630-1' },
  { name: 'feedback', path: './tabs/feedback.js?v=20260417-3' },
  { name: 'report', path: './tabs/report.js?v=20260518-1' },
  { name: 'retest', path: './tabs/retest.js?v=20260615-1' },
  { name: 'overall-test', path: './tabs/overall-test.js?v=20260630-2' },
  ...
  { name: 'assign', path: './tabs/assign.js?v=20260630-1' },
  { name: 'dispatch', path: './tabs/dispatch.js?v=20260417-3' },
  { name: 'data', path: './tabs/data.js?v=20260630-1' },
