...
import './zentao-hydrator.js?v=20260527-1';
...
import './components/story-preview-modal.js?v=20260527-1';
...
const OPTIONAL_TAB_MODULES = [
  { name: 'mine', path: './tabs/mine.js?v=20260527-1' },
  ...
  { name: 'assign', path: './tabs/assign.js?v=20260527-1' },
