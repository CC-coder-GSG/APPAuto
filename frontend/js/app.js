...
const OPTIONAL_TAB_MODULES = [
  { name: 'mine', path: './tabs/mine.js?v=20260715-1' },
  { name: 'review-workbench', path: './tabs/review-workbench.js?v=20260714-1' },
  ...
  { name: 'retest', path: './tabs/retest.js?v=20260715-1' },
  ...
  { name: 'feature-tree', path: './tabs/feature-tree.js?v=20260714-2' },
];
