...
const REQUIRED_NAMESPACES = {
  ...
  OmniQATestcaseCenterTab: ['loadTestcaseCenter', 'syncTestcaseCenter', 'openTestcaseCenterDetail'],
  OmniQAZentaoSyncTab: ['loadZentaoSyncBoard', 'openZentaoSyncEventDetail', 'saveZentaoSyncMapping'],
